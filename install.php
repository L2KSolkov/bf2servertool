...
$status = '';
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['server_ip']) && isset($_POST['server_port']) && isset($_POST['rcon_pass']) && isset($_POST['name']) && isset($_POST['username']) && isset($_POST['pass'])) {
	...
	if(!@fsockopen($_POST['server_ip'], $_POST['server_port'], $cn, $cs, 3)) {
		$errors[] = 'Could not connect to the server, please try again and check your server information';
	}
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					...
					<h1 class="center"><i class="fa fa-wrench"></i> Battlefield 2 Servertool</h1>
